 ...
 * emitted by shell-quote on flag values. `\'` is its own alternative so the
 * POSIX `'...'\''...'` concatenation (values containing an apostrophe) is
 * consumed fully instead of stopping at the first closing quote.
 */
