...
export const apiCreatePostgres = postgresSelectSchema.omit({ postgresId: true });

export const apiCreatePostgresOutput = postgresSelectSchema.omit({ postgresId: true });

export const apiFindOnePostgres = postgresSelectSchema.pick({ postgresId: true });
...
export const apiDeletePostgres = postgresSelectSchema.pick({ postgresId: true });
