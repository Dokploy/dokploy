import { createSchema } from "@dokploy/server/db/schema/application";
...
export const apiStopApplicationOutput = createSchema.extend({
  environment: environmentSelectSchema,
  domains: z.array(domainSelectSchema),
  deployments: z.array(deploymentSelectSchema),
  mounts: z.array(mountSelectSchema),
...
export const apiStartApplicationOutput = createSchema.extend({
  environment: environmentSelectSchema,
  domains: z.array(domainSelectSchema),
  deployments: z.array(deploymentSelectSchema),
  mounts: z.array(mountSelectSchema),
...
export const apiMoveApplicationOutput = createSchema.pick({
  applicationId: true,
  name: true,
  appName: true,
  description: true,
