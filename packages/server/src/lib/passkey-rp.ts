 ...
 *
 * Priority: cloud hardcode → optional `BETTER_AUTH_URL` / `NEXT_PUBLIC_APP_URL` → dev
 * localhost → **Settings → Server** (default for most self-hosted) → localhost fallback.
 *
 ...
 * canonical URL defaults to Settings → Server unless env override is set).
 */
