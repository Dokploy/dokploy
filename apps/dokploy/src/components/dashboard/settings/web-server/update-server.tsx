        ...
        {isUpdateAvailable && latestVersion && (
          <div className="mb-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p className="text">{t("updateReasonIntro")}</p>
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <Stars className="h-5 w-5 mt-0.5 text-[#5B9DFF]" />
                  <span className="text">{t("updateReasonItem1")}</span>
                </li>
                <li className="flex items-start gap-2">
                  <Bug className="h-5 w-5 mt-0.5 text-[#5B9DFF]" />
                  <span className="text">{t("updateReasonItem2")}</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="flex flex-col items-center gap-6 mb-6">
              ...
              <div className="text-center space-y-2">
                <h3 className="text-lg font-medium">{t("upToDateTitle")}</h3>
                <p className="text text-muted-foreground">
          ...
          <div className="rounded-lg bg-[#16254D] p-4 mb-8">
            <div className="flex gap-2">
              ...
              <div className="text-[#5B9DFF]">
                {t("releaseNotesIntro")}{" "}
                <Link
                  href="https://github.com/MkinG2k0/dokploy/releases"
                  target="_blank"
