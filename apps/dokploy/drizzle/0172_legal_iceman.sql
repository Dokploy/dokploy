...
ALTER TABLE "cloudflare" ADD COLUMN "defaultAllowEmailDomains" text[] DEFAULT ARRAY[]::text[] NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "cloudflare_access_application_domainId_unique" ON "cloudflare_access_application" USING btree ("domainId");
