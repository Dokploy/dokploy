...
export const ReSmsIcon = ({ className }: Props) => {
	return (
		<svg
			viewBox="0 0 512 512"
			className={cn("size-8", className)}
		...
		>
			<path
				d="M60.4954 142.836C63.9702 114.553 65.7076 100.412 74.7741 90.849C83.8406 81.2858 97.8692 78.7974 125.926 73.8207L392.915 26.4625C440.668 17.9922 464.544 13.7571 479.133 27.2784C493.723 40.7997 491.312 64.9284 486.491 113.186L460.294 375.404C457.336 405.008 455.857 419.81 446.457 429.736C437.057 439.662 422.357 441.943 392.957 446.505L120.575 488.772C72.6036 496.216 48.6179 499.938 34.3215 486.088C20.0251 472.238 22.985 448.146 28.9048 399.963L60.4954 142.836Z"
				fill="black"
			/>
			<path
				d="M199.965 266.088L179.601 250.394C151.886 229.035 138.029 218.355 140.825 206.966C143.621 195.576 160.848 192.528 195.303 186.43L314.929 165.259C349.311 159.175 366.502 156.133 373.039 165.855C379.576 175.578 370.272 190.35 351.664 219.894L280.452 332.961C253.488 375.773 240.005 397.179 226.998 393.424C213.99 389.669 213.99 364.371 213.99 313.776L213.99 294.603C213.99 285.909 213.99 281.563 212.142 277.806C210.294 274.048 206.851 271.395 199.965 266.088Z"
				fill="white"
			/>
		</svg>
	);
