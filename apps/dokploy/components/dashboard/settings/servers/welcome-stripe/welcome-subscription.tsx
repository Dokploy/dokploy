			...
			<DialogContent className="sm:max-w-7xl min-h-[75vh]">
				...
				<DialogHeader>
					<DialogTitle className="text-2xl text-center">
						Welcome To Gocker Cloud 🎉
					</DialogTitle>
					<DialogDescription className="text-center max-w-xl mx-auto">
						Thank you for choosing Gocker Cloud! 🚀 We're excited to have you
								...
								return (
									<div className="flex flex-col gap-6">
										<div className="flex flex-col gap-2">
											...
											<p className="text-muted-foreground">
												Here are some of the things you can do with Gocker
												Cloud:
											</p>
										</div>
