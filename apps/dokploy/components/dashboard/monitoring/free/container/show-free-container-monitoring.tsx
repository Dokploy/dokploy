		...
		<div className="rounded-xl bg-background flex flex-col gap-4">
			<header className="flex items-center justify-between">
				<div className="space-y-1">
					...
					<p className="text-sm text-muted-foreground">
						{t("dashboard.monitoring.description")}
					</p>
				</div>
			</header>
			...
			<div className="grid gap-6 lg:grid-cols-2">
				<Card className="bg-background">
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="text-sm font-medium">
							{t("dashboard.monitoring.cpuUsage")}
						</CardTitle>
					</CardHeader>
					<CardContent>
						<div className="flex flex-col gap-2 w-full">
							<span className="text-sm text-muted-foreground">
								{t("dashboard.monitoring.used")}: {currentData.cpu.value}
							</span>
				...
				<Card className="bg-background">
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="text-sm font-medium">
							{t("dashboard.monitoring.memoryUsage")}
						</CardTitle>
					</CardHeader>
					<CardContent>
						<div className="flex flex-col gap-2 w-full">
							<span className="text-sm text-muted-foreground">
								{`${t("dashboard.monitoring.used")}:  ${
									currentData.memory.value.used
								} / ${t("dashboard.monitoring.limit")}: ${
				...
				{appName === "dokploy" && (
					<Card className="bg-background">
						<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
							<CardTitle className="text-sm font-medium">
								{t("dashboard.monitoring.diskSpace")}
							</CardTitle>
						</CardHeader>
						<CardContent>
							<div className="flex flex-col gap-2 w-full">
								<span className="text-sm text-muted-foreground">
									{`${t("dashboard.monitoring.used")}:  ${
										currentData.disk.value.diskUsage
									} GB / ${t("dashboard.monitoring.limit")}: ${
										currentData.disk.value.diskTotal
									} GB`}
								</span>
								<Progress
				...
				<Card className="bg-background">
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="text-sm font-medium">
							{t("dashboard.monitoring.blockIO")}
						</CardTitle>
					</CardHeader>
					<CardContent>
						<div className="flex flex-col gap-2 w-full">
							<span className="text-sm text-muted-foreground">
								{`${t("dashboard.monitoring.read")}:  ${
									currentData.block.value.readMb
								}  / ${t("dashboard.monitoring.write")}: ${
				...
				<Card className="bg-background">
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						<CardTitle className="text-sm font-medium">
							{t("dashboard.monitoring.networkIO")}
						</CardTitle>
					</CardHeader>
					<CardContent>
						<div className="flex flex-col gap-2 w-full">
							<span className="text-sm text-muted-foreground">
								{`${t("dashboard.monitoring.inMB")}: ${
									currentData.network.value.inputMb
								}  / ${t("dashboard.monitoring.outMB")}: ${
