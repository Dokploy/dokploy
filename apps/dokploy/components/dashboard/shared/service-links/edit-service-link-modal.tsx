...
interface ServiceLinkAttribute {
	serviceLinkAttributeId: string;
	attribute: string;
...
interface ServiceLink {
	...
	attributes?: ServiceLinkAttribute[];
	targetService?: {
		name: string;
		appName: string;
	} | null;
...
export const EditServiceLinkModal = ({
	...
	const form = useForm<EditServiceLinkForm>({
		...
		defaultValues: {
			...
			attributes: serviceLink.attributes?.map(attr => ({
				attribute: attr.attribute as "fqdn" | "hostname" | "port",
