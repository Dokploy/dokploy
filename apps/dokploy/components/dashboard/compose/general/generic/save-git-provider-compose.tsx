...
const createSchema = (t: (key: string) => string) =>
	z.object({
		composePath: z
			.string()
			.min(1, { message: t("compose.git.validation.composePathRequired") }),
		repositoryURL: z.string().min(1, {
			message: t("compose.git.validation.repositoryUrlRequired"),
		}),
		branch: z
			.string()
			.min(1, { message: t("compose.git.validation.branchRequired") }),
