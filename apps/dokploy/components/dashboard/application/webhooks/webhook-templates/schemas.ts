...
export const n8nConfigSchema = z.object({
  ...
  minimumSeverity: z.enum(["all", "warning", "error"]).optional().default("all"),
...
export const slackConfigSchema = z.object({
  ...
  threadingStrategy: z
    ...
    .optional()
    .default("per-app"),
  colorScheme: z.enum(["default", "custom", "monochrome"]).optional().default("default"),
  ...
  customActions: z
    .array(
      z.object({
        ...
        url: z.string().url(),
        style: z.enum(["primary", "danger", "default"]).optional().default("default"),
      })
    )
    .optional(),
});
