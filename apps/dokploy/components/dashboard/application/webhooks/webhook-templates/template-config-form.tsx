...
import { n8nConfigSchema, slackConfigSchema, type N8nConfig, type SlackConfig } from "./schemas";
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Optional workflow identifier" {...field} />
                    </FormControl>
                    <FormDescription>
                  ...
                  {watchBranches.map((branch, index) => (
                    <div key={index} className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        size="icon"
                        onClick={() => {
                          const newBranches = watchBranches.filter((_, i) => i !== index);
                          form.setValue("branches", newBranches);
                        }}
                      >
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            ...
                            <p>Function signature: (payload, context) =&gt; payload</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </FormLabel>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="per-app">Per Application</SelectItem>
                          <SelectItem value="per-deployment">Per Deployment</SelectItem>
                    ...
                    <div key={index} className="space-y-2 rounded-lg border p-3">
                      ...
                      <div className="flex items-center justify-between">
                        <Select
                          ...
                          onValueChange={(value: "default" | "primary" | "danger") => {
                            const actions = [...watchCustomActions];
                            actions[index] = { 
                              text: actions[index]?.text || "",
                              url: actions[index]?.url || "",
