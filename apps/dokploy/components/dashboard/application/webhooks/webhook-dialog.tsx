...
const WebhookDialog = DialogPrimitive.Root;

const WebhookDialogTrigger = DialogPrimitive.Trigger;

const WebhookDialogPortal = DialogPrimitive.Portal;

const WebhookDialogClose = DialogPrimitive.Close;

const WebhookDialogOverlay = React.forwardRef<
