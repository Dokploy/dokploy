...
export const StandardEnvForm: React.FC<StandardEnvFormProps> = ({ value, onChange }) => {
  const [isVisible, setIsVisible] = React.useState(false);
  const [pairs, setPairs] = React.useState<EnvPair[]>(() => parseEnvString(value));
  ...
  const updatePair = (index: number, field: keyof EnvPair, newValue: string) => {
