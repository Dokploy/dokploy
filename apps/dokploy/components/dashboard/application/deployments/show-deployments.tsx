                        ...
                        <div className="flex flex-row items-center gap-2 flex-wrap">
                            ...
                            <div className="flex flex-row items-center gap-2">
                                <Badge
                                    ...
                                    variant="outline"
                                    onClick={() => {
                                        copy(`${url}/api/deploy${type === "compose" ? "/compose" : ""}/${refreshToken}`);
                        ...
                        {deployments?.map((deployment, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div
                                        className="flex w-full flex-col items-start gap-2 sm:w-auto sm:max-w-[300px] sm:items-end sm:justify-start">
                                        <div
                                            className="text-sm capitalize text-muted-foreground flex flex-wrap items-center gap-2">
                                            ...
                                            {deployment?.rollback &&
                                                ...
                                                type === "application" && (
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <RefreshCcw
                                                                className="size-4 text-primary group-hover:text-red-500"/>
                                                            Rollback
                                                        </Button>
                                                    </DialogAction>
                                                )}
