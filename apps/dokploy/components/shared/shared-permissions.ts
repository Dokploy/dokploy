...
export const getDefaultPermissionsByRole = (role: TeamRole | undefined): BasePermissions => {
  switch (role) {
    case 'OWNER':
      return {
        accesedProjects: [],
...
export const getTeamDefaultPermissionsByRole = (role: TeamRole): TeamPermissions => {
