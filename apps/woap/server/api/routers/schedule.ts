import { IS_CLOUD, removeScheduleJob, scheduleJob } from "@woap/server";
import { db } from "@woap/server/db";
import { deployments } from "@woap/server/db/schema/deployment";
import {
	createScheduleSchema,
	schedules,
	updateScheduleSchema,
} from "@woap/server/db/schema/schedule";
import { runCommand } from "@woap/server/index";
import {
	createSchedule,
	deleteSchedule,
	findScheduleById,
	updateSchedule,
} from "@woap/server/services/schedule";
