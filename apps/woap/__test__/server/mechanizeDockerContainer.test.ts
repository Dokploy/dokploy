...
import type { ApplicationNested } from "@woap/server/utils/builders";
import { mechanizeDockerContainer } from "@woap/server/utils/builders";
...
vi.mock("@woap/server/utils/servers/remote-docker", () => ({
