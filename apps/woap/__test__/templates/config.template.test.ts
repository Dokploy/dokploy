import type { Schema } from "@woap/server/templates";
import type { CompleteTemplate } from "@woap/server/templates/processors";
import { processTemplate } from "@woap/server/templates/processors";
