...
import type { ApplicationNested } from "@woap/server";
import { unzipDrop } from "@woap/server";
import { paths } from "@woap/server/constants";
import AdmZip from "adm-zip";
import { afterAll, beforeAll, describe, expect, it, vi } from "vitest";

const { APPLICATIONS_PATH } = paths();
vi.mock("@woap/server/constants", async (importOriginal) => {
